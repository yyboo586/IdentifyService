...
CREATE TABLE `sys_role`  (
  ...
  `list_order` INT(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '排序;0:默认排序',
  ...
  `effectiveTime` TEXT DEFAULT NULL COMMENT '角色有效日期',
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `casbin_rule` VALUES ('g', 'u_1', '1', '', '', '', '');    -- g 将用户加入到角色中
INSERT INTO `casbin_rule` VALUES ('p', '1', '1', 'All', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', '1', '2', 'All', '', '', '');   -- p 添加权限
...
INSERT INTO `casbin_rule` VALUES ('p', '1', '7', 'All', '', '', '');
...
(1, 0, 'DataCenter',                     '数据中心', 'ele-Stamp',    '', '', 0, 30, 0, '/system/auth1',           'layout/routerView/parent', 0, '', 0, 0, 1, '0', 0, '', '2022-03-24 15:03:37', '2022-04-14 16:29:19'),
(2, 1, 'DataCenter/DateReports',         '数据统计', 'ele-Calendar', '', '', 1,  0, 0, '/system/auth1/menuList1', 'system/menu/index',        0, '', 0, 0, 1, '',  0, '', '2022-03-24 17:24:13', '2022-03-29 10:54:49'),
(3, 0, 'DeviceManagement',               '设备管理', 'ele-Stamp',    '', '', 0,  0, 0, '/system/auth2',           'layout/routerView/parent', 0, '', 0, 0, 1, '',  0, '', '2022-03-29 16:48:43', '2022-03-29 17:05:19'),
(4, 3, 'DeviceManagement/DeviceDefine',  '产品定义', 'ele-Calendar', '', '', 1,  0, 0, '/system/auth2/menuList1', 'system/menu/index',        0, '', 0, 0, 1, '',  0, '', '2022-03-29 17:04:25', '2022-03-29 18:11:36'),
(5, 3, 'DeviceManagement/DeviceList',    '设备列表', 'ele-Calendar', '', '', 1,  0, 0, '/system/auth2/menuList2', 'system/role/index',        0, '', 0, 0, 1, '',  0, '', '2022-03-29 18:15:03', '2022-03-30 10:25:34'),
(6, 3, 'DeviceManagement/DeviceImport',  '设备导入', 'ele-Calendar', '', '', 1,  0, 0, '/system/auth2/menuList3', 'system/menu/index',        0, '', 0, 0, 1, '',  0, '', '2022-04-06 14:49:10', '2022-04-06 14:49:17'),
(7, 3, 'DeviceManagement/DeviceUpgrade', '设备升级', 'ele-Calendar', '', '', 1,  0, 0, '/system/auth2/menuList4', 'system/menu/index',        0, '', 0, 0, 1, '',  0, '', '2022-04-06 14:49:46', '2022-04-06 14:49:46')
;
...
INSERT INTO `sys_dept` VALUES (1, 0, '0', '默认组织', 0, '[1,2,3]', '15888888888', 'ry@qq.com', 1, 0, 31, '2021-07-13 15:56:52', '2024-01-29 16:00:28', NULL);
