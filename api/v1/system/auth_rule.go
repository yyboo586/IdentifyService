...
type RuleAddReq struct {
	g.Meta `path:"/menu" tags:"菜单管理" method:"post" summary:"菜单创建"`
	model.Author
...
type RuleDeleteReq struct {
	g.Meta `path:"/menu" tags:"菜单管理" method:"delete" summary:"菜单删除"`
	model.Author
...
type RuleUpdateReq struct {
	g.Meta `path:"/menu/{id}" tags:"菜单管理" method:"put" summary:"菜单修改(全量更新)"`
	model.Author
