...
type UserCreateReq struct {
	g.Meta `path:"/orgs/{org_id}/users" tags:"组织架构/账户管理" method:"post" summary:"账户创建"`
	model.Author
...
type UserRegisterReq struct {
	g.Meta   `path:"/user/register" tags:"组织架构/账户管理" method:"post" summary:"账户注册" dc:"适用于前台用户注册"`
...
type UserDeleteReq struct {
	g.Meta `path:"/orgs/{org_id}/users" tags:"组织架构/账户管理" method:"delete" summary:"删除用户"`
	model.Author
...
type UserEditReq struct {
	g.Meta `path:"/orgs/{org_id}/users/{user_id}" tags:"组织架构/账户管理" method:"patch" summary:"编辑用户"`
	model.Author
	...
	Address  string `json:"address" dc:"用户地址"`
	Describe string `json:"describe" dc:"用户描述"`
	Status   int64  `json:"status" dc:"用户状态(1:启用,2:禁用)"`
}
...
type EditUserRolesReq struct {
	g.Meta `path:"/orgs/{org_id}/users/{user_id}/roles" tags:"组织架构/账户管理" method:"put" summary:"修改用户角色"`
	model.Author
	OrgID   string  `p:"org_id" v:"required#组织ID不能为空" dc:"组织ID"`
	UserID  string  `p:"user_id" v:"required#用户ID不能为空" dc:"用户ID"`
	RoleIDs []int64 `json:"role_ids" dc:"用户关联角色ID列表"`
...
type UserResetPwdReq struct {
	g.Meta `path:"/orgs/{org_id}/users/{user_id}/reset-credentials" tags:"组织架构/账户管理" method:"put" summary:"重置密码"`
	model.Author
	OrgID  string `p:"org_id" v:"required#组织ID不能为空" dc:"组织ID"`
	UserID string `p:"user_id" v:"required#用户ID不能为空" dc:"用户ID"`
}
...
type GetUserInfoReq struct {
	g.Meta `path:"/orgs/{org_id}/users/{user_id}" tags:"组织架构/账户管理" method:"get" summary:"用户详情"`
	model.Author
	OrgID  string `p:"org_id" v:"required#组织ID不能为空" dc:"组织ID"`
	UserID string `p:"user_id" v:"required#用户ID不能为空" dc:"用户ID"`
}
...
type UserSearchReq struct {
	g.Meta `path:"/orgs/{org_id}/users" tags:"组织架构/账户管理" method:"get" summary:"用户搜索"`
	model.Author
	OrgID string `p:"org_id" v:"required#组织ID不能为空" dc:"组织ID"`
