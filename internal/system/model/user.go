...
// 用户管理权限点常量
const (
	UserCreate PermissionPoint = "user:create"
	UserDelete PermissionPoint = "user:delete"
	UserEdit   PermissionPoint = "user:edit"
	UserView   PermissionPoint = "user:view"
	UserList   PermissionPoint = "user:list"
)
