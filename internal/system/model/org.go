...
// 组织管理权限点常量
const (
	OrgView   PermissionPointCode = "org:view"
	OrgCreate PermissionPointCode = "org:create"
	OrgEdit   PermissionPointCode = "org:edit"
	OrgDelete PermissionPointCode = "org:delete"
)

var OrgResources []*Resource = []*Resource{
...
// 组织管理权限点清单
var OrgPermissions []*PermissionPoint = []*PermissionPoint{
	{
		Code:     OrgCreate,
		CodeName: "创建组织",
		Resources: []*Resource{
