...
func (c *orgService) CreateOrg(ctx context.Context, req *system.OrgCreateReq) (res *system.OrgCreateRes, err error) {
	err = c.checkPermission(ctx, []model.PermissionPointCode{model.OrgCreate})
	if err != nil {
		return nil, err
	}
...
func (c *orgService) DeleteOrg(ctx context.Context, req *system.OrgDeleteReq) (res *system.OrgDeleteRes, err error) {
	err = c.checkPermission(ctx, []model.PermissionPointCode{model.OrgDelete})
	if err != nil {
		return nil, err
	}
...
func (c *orgService) EditOrg(ctx context.Context, req *system.OrgEdiReq) (res *system.OrgEditRes, err error) {
	err = c.checkPermission(ctx, []model.PermissionPointCode{model.OrgEdit})
	if err != nil {
		return nil, err
	}
...
func (c *orgService) GetOrg(ctx context.Context, req *system.OrgGetReq) (res *system.OrgGetRes, err error) {
	err = c.checkPermission(ctx, []model.PermissionPointCode{model.OrgView})
	if err != nil {
		return nil, err
	}
...
func (c *orgService) checkPermission(ctx context.Context, permissionPoints []model.PermissionPointCode) (err error) {
	...
	for _, permission := range permissionPoints {
		...
		if !hasPermission {
			return fmt.Errorf("%w, %v", model.ErrPermissionDenied, "没有权限执行操作")
		}
	}
	return nil
}
