...
func (c *loginController) Login(ctx context.Context, req *system.UserLoginReq) (res *system.UserLoginRes, err error) {
	...
	token, err = service.Token().Generate(ctx, tokenData)
	if err != nil {
		g.Log().Error(ctx, err)
...
func (c *loginController) ListUserDevices(ctx context.Context, req *system.ListUserDeviceReq) (res *system.ListUserDeviceRes, err error) {
...
func (c *loginController) DeleteUserDevice(ctx context.Context, req *system.DeleteUserDeviceReq) (res *system.DeleteUserDeviceRes, err error) {
