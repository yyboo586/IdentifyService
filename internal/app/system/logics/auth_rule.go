...
// ========== 登录场景接口 ==========
func (a *authRule) GetUserMenuTree(ctx context.Context, userID string) (out []*model.AuthRuleNode, err error) {
...
func (a *authRule) GetUserButtonList(ctx context.Context, userID string) (out []*model.AuthRule, err error) {
	if userInstance.IsSuperAdmin(ctx, userID) {
